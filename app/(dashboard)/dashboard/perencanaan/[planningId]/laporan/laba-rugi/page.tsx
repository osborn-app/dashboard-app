            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-3 px-4 text-gray-900 font-medium">KUMULATIF LABA (RUGI)</td>
                  <td className="py-3 px-4 text-center font-mono text-gray-900">20.000.000.000</td>
                ...
                <tr className="border-b border-gray-100">
                  <td className="py-3 px-4 text-gray-900"></td>
                  <td className="py-3 px-4 text-gray-900 font-medium">PENDAPATAN OPERASIONAL</td>
                  <td className="py-3 px-4 text-center font-mono text-gray-900">25.000.000.000</td>
                  <td className="py-3 px-4 text-center font-mono text-gray-900">0</td>
                  <td className="py-3 px-4 text-center font-mono text-gray-900">0</td>
                  <td className="py-3 px-4 text-center font-mono text-gray-900">0</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-3 px-4 text-gray-900"></td>
                  <td className="py-3 px-4 text-gray-900 font-medium">BEBAN OPERASIONAL</td>
                  <td className="py-3 px-4 text-center font-mono text-gray-900">0</td>
