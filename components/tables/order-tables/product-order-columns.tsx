...
import { ProductOrderCellAction } from "./product-order-cell-action";
...
export const pendingProductOrderColumns: ColumnDef<any>[] = [
  {
  ...
  },
  {
    accessorKey: "product",
    header: () => (
      <span className="text-sm font-semibold text-neutral-700">Produk</span>
    ),
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Link
        href={`/dashboard/product-orders/${row.original?.id}/preview`}
...
export const confirmedProductOrderColumns: ColumnDef<any>[] = [
  {
    accessorKey: "customer",
    header: () => (
      <span className="text-sm font-semibold text-neutral-700">Pelanggan</span>
  ...
  {
    id: "actions",
    cell: ({ row }) => <ProductOrderCellAction data={row.original} />,
    enableSorting: false,
  },
];

export const onProgressProductOrderColumns: ColumnDef<any>[] = [
  {
    accessorKey: "customer",
    header: () => (
      <span className="text-sm font-semibold text-neutral-700">Pelanggan</span>
...
export const completedProductOrderColumns: ColumnDef<any>[] = [
  {
    accessorKey: "customer",
    header: () => (
      <span className="text-sm font-semibold text-neutral-700">Pelanggan</span>
